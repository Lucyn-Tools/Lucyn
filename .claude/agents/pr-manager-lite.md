...
Also do a standards pass against `CLAUDE.md` on the diff:
...
- Frontend reads env via `apps/web/src/lib/` helpers — no inline `process.env` in components.
