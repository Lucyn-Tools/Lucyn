...
- **PR reference**: a URL like `https://github.com/lucyn-ai/lucyn/pull/742` or a bare number (`#742` / `742`). If missing or ambiguous, stop and ask.
...
**Documentation** — code comments match new behavior; `CLAUDE.md` updated for rule changes; capability changes reflected in relevant README sections.
...
#### 3. `packages/ai/src/rag.ts:200-240` — <short title>
<…>
...
- `apps/web/src/lib/auth.ts:3` — unused import.
