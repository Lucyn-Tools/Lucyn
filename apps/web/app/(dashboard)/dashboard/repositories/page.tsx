export default function RepositoriesPage() {
  return (
    <div className="max-w-6xl mx-auto">
      <h1 className="text-2xl font-semibold text-text-primary mb-2">Repositories</h1>
      <p className="text-text-secondary text-sm mb-6">Health and activity across your connected repositories</p>
